...
class AddExpense extends React.Component {
    ...
    add = async (e) => {
        e.preventDefault();
        if (this.state.desc === "" || this.state.amount === "" || this.state.date === "") {
        ...
        this.setState({ desc: "", date: "", amount: "", amountType: "debit" });
    };
            ...
            <div className="ui main">
                ...
                <form className="ui form" onSubmit={this.add}>
                    ...
                    <div className="field date picker">
                        <label>Date</label>
                        <input type="date" id="date" name="date" value={this.state.date} onChange={(e) => this.setState({ date: e.target.value})}>
                        </input>
                    </div>
                    <div className="field">
